		...
		<div class="box clearfix">
			...
			<div class="rbox">
				<div class="tablecontain">
					<div class="tabletitle">信息管理</div>
					<form action="user/userchangeif" class="form-horizontal" id="changepsw" role="form" method="post" > 
						<br/>
						<div class="form-group">
					    	<label for="psw1" class="col-sm-2 control-label">联系电话</label>
					    	<div class="col-sm-7">
					      	<input type="text" class="form-control" id="psw0" name="tel" value='' placeholder="请输入..." required="required">
					    	</div>
					 	</div>
					 	<br/>
						<div class="form-group">
					    	<label for="psw1" class="col-sm-2 control-label">联系邮箱</label>
					    	<div class="col-sm-7">
					      	<input type="text" class="form-control" id="psw1" name="email" value='' placeholder="请输入..." required="required">
					    	</div>
					 	</div>
