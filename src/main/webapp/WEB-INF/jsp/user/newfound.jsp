	...
	<div class="poi-container">
		...
		<div class="publishbox">
			...
			<div class="publishbox_content">
				<form class="form-horizontal form_psw" id="pubform" role="form" method="post" action="user/newfound" > 
					<input type="hidden" value="/img/faces/default.jpg" id="lostimgname" name="foundimg" />
					<div class="form-group">
					...
					<div class="form-group">
				    	<label for="psw1" class="col-sm-2 control-label">拾取时间 :</label>
				    	<div class="col-sm-7">
				 	...
				 	<div class="form-group">
				    	<label for="psw2" class="col-sm-2 control-label">拾取地点 :</label>
				    	<div class="col-sm-7">
...
<script type="text/javascript">
	...
	$(document).ready(function () {
	       var msg ="${msg}";
	        ...
	        {
	            alert(msg);
	            window.location.href="user/newfound";
