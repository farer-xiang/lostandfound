				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						...
						<div class="panel-body">
							...
							<div class="li">
								<h5>修改用户 --- ${user.uid}</h5>
								<form class="form-horizontal" action="admin/userchange" method="post">
								
								<input class="form-control" type="hidden" id="stuno" name="uid" value="${user.uid}">
									
								<div class="form-group">
									<label class="col-sm-2 control-label" for="stuname">姓名：</label>
									<div class="col-sm-4">
									<input class="form-control" type="text" id="stuname" name="stuname" value="${user.name}" required>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label" for="stupass">密码：</label>
									<div class="col-sm-4">
									<input class="form-control" type="text" id="stupass" name="stupass" value=" " required>
									</div>
									<span>(密码长度6-15位)</span>
								</div>
								<div class="form-group">
